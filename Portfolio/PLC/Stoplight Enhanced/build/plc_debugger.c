 ...
 * Declare programs 
 **/
extern STOPLIGHT_ENHANCED RES0__INSTANCE0;
...
{&(RES0__INSTANCE0.COUNTER), DINT_ENUM},
{&(RES0__INSTANCE0.STOPLIGHT_STOP_TIME), DINT_ENUM},
{&(RES0__INSTANCE0.YELLOW_STOP_TIME), DINT_ENUM},
{&(RES0__INSTANCE0.STATE), DINT_ENUM},
{&(RES0__INSTANCE0.A1), BOOL_ENUM},
{&(RES0__INSTANCE0.A2), BOOL_ENUM},
{&(RES0__INSTANCE0.AP), BOOL_ENUM},
{&(RES0__INSTANCE0.B1), BOOL_ENUM},
{&(RES0__INSTANCE0.B2), BOOL_ENUM},
{&(RES0__INSTANCE0.BP), BOOL_ENUM},
{&(RES0__INSTANCE0.C1), BOOL_ENUM},
{&(RES0__INSTANCE0.C2), BOOL_ENUM},
{&(RES0__INSTANCE0.CP), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.EN), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.INPUT), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.O_G), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.O_Y), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.O_R), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.STOP_TIME), DINT_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.EXT_CTER), DINT_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.EXT_STOP_TIME), DINT_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.DUAL_Y), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.DUAL_Y_CTER), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.R_TRIG0.EN), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.R_TRIG0.ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.R_TRIG0.CLK), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.R_TRIG0.Q), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.R_TRIG0.M), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.TFF0.EN), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.TFF0.ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.TFF0.INPUT), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.TFF0.LATCH), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0.TFF0.OUTPUT), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0._TMP_SUB72_OUT), DINT_ENUM},
{&(RES0__INSTANCE0.LIGHTS0._TMP_GE75_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0._TMP_NOT80_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0._TMP_AND1_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0.LIGHTS0._TMP_AND4_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0.A1G), BOOL_ENUM},
{&(RES0__INSTANCE0.A1Y), BOOL_ENUM},
{&(RES0__INSTANCE0.A1R), BOOL_ENUM},
{&(RES0__INSTANCE0.A1_MODE), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_ADD6_ENO), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_ADD6_OUT), DINT_ENUM},
{&(RES0__INSTANCE0._TMP_GE10_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_MOVE47_ENO), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_MOVE47_OUT), DINT_ENUM},
{&(RES0__INSTANCE0._TMP_GE23_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_MOVE8_ENO), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_MOVE8_OUT), DINT_ENUM},
{&(RES0__INSTANCE0._TMP_EQ39_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_EQ41_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_EQ43_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_ADD19_ENO), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_ADD19_OUT), DINT_ENUM}
};

static const dbgvardsc_index_t retain_list[] = {
/* RES0__INSTANCE0.LIGHTS0.R_TRIG0.M */ 29
};
