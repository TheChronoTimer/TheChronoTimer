 ...
 * Declare programs 
 **/
extern HELLOWORLD RES0__INSTANCE0;
...
{&(RES0__INSTANCE0.HELLO_WORLD), BOOL_ENUM},
{&(RES0__INSTANCE0.SELECT), INT_ENUM},
{&(RES0__INSTANCE0.MODE_1), BOOL_ENUM},
{&(RES0__INSTANCE0.MODE_2), BOOL_ENUM},
{&(RES0__INSTANCE0.MODE_3), BOOL_ENUM},
{&(RES0__INSTANCE0.MODE_4), BOOL_ENUM},
{&(RES0__INSTANCE0.LED), BOOL_ENUM},
{&(RES0__INSTANCE0.LED0), BOOL_ENUM},
...
{&(RES0__INSTANCE0._TMP_MOVE27_ENO), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_MOVE27_OUT), INT_ENUM},
{&(RES0__INSTANCE0._TMP_MOVE1_ENO), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_MOVE1_OUT), INT_ENUM},
{&(RES0__INSTANCE0._TMP_MOVE2_ENO), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_MOVE2_OUT), INT_ENUM},
{&(RES0__INSTANCE0._TMP_MOVE3_ENO), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_MOVE3_OUT), INT_ENUM},
{&(RES0__INSTANCE0._TMP_EQ35_OUT), BOOL_ENUM}
};

static const dbgvardsc_index_t retain_list[] = {
/* RES0__INSTANCE0.R_TRIG0.M */ 14,
/* RES0__INSTANCE0.F_TRIG0.M */ 19
};
