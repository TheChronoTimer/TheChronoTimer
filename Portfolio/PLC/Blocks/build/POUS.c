...
void BLOCKS_body__(BLOCKS *data__) {
  ...
  __SET_VAR(data__->TFF0.,INPUT,,__GET_VAR(data__->INPUT,));
  TFF_body__(&data__->TFF0);
  __SET_VAR(data__->,OUTPUT0,,__GET_VAR(data__->TFF0.OUTPUT,));
  __SET_VAR(data__->ONS0.,INPUT,,__GET_VAR(data__->INPUT,));
  ONS_body__(&data__->ONS0);
  __SET_VAR(data__->,OUTPUT1,,__GET_VAR(data__->ONS0.OUTPUT,));
